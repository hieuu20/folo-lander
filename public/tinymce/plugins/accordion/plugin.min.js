...
!(function () {
    ...
    const $ = (e) => void 0 !== e.style && a(e.style.getPropertyValue),
        ...
        W = (e, t) =>
            ((e, t) => {
                ...
                return R(o)
                    ? u.none()
                    : u.from(o.querySelector(e)).map(M.fromDom)
            })(t, e),
        X = ((e, t) => {
    ...
    const ee = (e, t) => ({ element: e, offset: t }),
        ...
        se = {
            ...
            query: l({
                ...
                prevSibling: (e) =>
                    u.from(e.dom.previousSibling).map(M.fromDom),
                nextSibling: I,
            }),
            property: l({
                children: j,
                ...
                parent: V,
                document: (e) => {
                    return ((t = e), A(t) ? t : M.fromDom(t.dom.ownerDocument))
                        .dom
                    var t
                },
                isText: T,
    ...
    const ue = (e) => 'SUMMARY' === (null == e ? void 0 : e.nodeName),
        ...
        fe = (e) =>
            !he(e) &&
            e.dom.isEditable(e.selection.getNode()) &&
            !e.mode.isReadOnly(),
        ...
        ;((e) => {
            ...
            e.on('ExecCommand', (t) => {
                ...
                ;('delete' !== o && 'forwarddelete' !== o) ||
                    ...
                    ((e) => {
                        me.each(
                            me.grep(e.dom.select('details', e.getBody())),
                            be(e)
                        )
                    })(e)
            })
