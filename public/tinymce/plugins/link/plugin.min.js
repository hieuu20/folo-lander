...
!(function () {
            ...
            ((e) => {
                ...
                return new Promise((e) => {
                    o(n)
                        ? fetch(n)
                              .then((e) =>
                                  e.ok ? e.text().then(be) : Promise.reject()
                              )
                              .then(e, () => e(m.none()))
                        : c(n)
                        ? n((t) => e(m.some(t)))
    ...
    const Ne = (e, t) => {
        ...
        Te = (e) =>
            ...
            ((e) => {
                ...
                : ((e) => {
                      ...
                      return x(t.length > 0, t[0]).or(
                          Ae(e, e.selection.getNode())
                      )
                  })(e),
        Ee = (e) => () => {
        ...
        Re = (e) => (t) => {
            const n = () => {
                t.setActive(
                    !e.mode.isReadOnly() && G(e, e.selection.getNode())
                ),
                ...
                o = (n) => {
                    t.setEnabled(
                        ((t) => {
                            return (
                                Q(t) ||
                                ((n = e.selection.getRng()), J(n).length > 0)
                            )
                            var n
            ...
            ;((e, t) => {
                ...
                ((e, t) => {
                    const n = (t) => {
                        ...
                        return (
                            t.setEnabled(G(e, n) && e.selection.isEditable()), g
                        )
                    }
