export * from './DeepConnectionText';
export * from './DeepConnectionImage';
...
//       {
//         className:
//           "z-0 w-[39.2%] md:w-[29.6%] left-[-16%] md:left-0 top-[-36%]",
//         photo: community_1,
//         y: "-18vh",
//         ref: scope_1,
//         animate: animate_1,
...
//       {
//         className:
//           "z-[2] w-[39.2%] md:w-[29.6%] left-[16%] md:left-[24%] top-[-8%]",
//         photo: community_2,
//         y: "-38vh",
//         ref: scope_2,
//         animate: animate_2,
...
//       {
//         className:
//           "z-0 w-[39.2%] md:w-[29.6%] left-[48%] md:left-[46%] top-[-36%]",
//         photo: community_3,
//         y: "-10vh",
//         ref: scope_3,
//         animate: animate_3,
...
//       {
//         className:
//           "z-[2] w-[39.2%] md:w-[29.6%] left-[80%] md:left-[70%] top-[-8%]",
//         photo: community_4,
//         y: "-38vh",
//         ref: scope_4,
//         animate: animate_4,
...
//     () => [
//       {
//         className: "z-0 w-[39.2%] md:w-[29.6%] left-[-16%] md:left-0 top-[-8%]",
//         photo: community_5,
//         y: "50vh",
//         ref: scope_5,
//         animate: animate_5,
...
//       {
//         className:
//           "z-[1] w-[39.2%] md:w-[29.6%] left-[16%] md:left-[24%] top-[16%]",
//         photo: community_6,
//         y: "30vh",
//         ref: scope_6,
//         animate: animate_6,
...
//       {
//         className:
//           "z-0 w-[39.2%] md:w-[29.6%] left-[48%] md:left-[46%] top-[-8%]",
//         photo: community_7,
//         y: "48vh",
//         ref: scope_7,
//         animate: animate_7,
...
//       {
//         className:
//           "z-[1] w-[39.2%] md:w-[29.6%] left-[80%] md:left-[70%] top-[16%]",
//         photo: community_8,
//         y: "30vh",
//         ref: scope_8,
//         animate: animate_8,
...
//           <Title
//             order={2}
//             fz={{ base: 40, md: 56, lg: 72, xl: 90, "2xl": 104 }}
//             fw={700}
//             lh={1.375}
//             ta={"center"}
//           >
