...
const list: Unlimited[] = [
    {
        ...
        popupDescription: "Multi-level subscriptions for every niche and price point. Build custom channels and collabs with upsells that keep fans engaged.",
    ...
    },
    {
        ...
        popupDescription: "Chat, share media, and calls all while monetising every interaction. Personalised conversations that build loyalty and revenue.",
        popupButtonTitle: "Join KNKY →",
        popupButtonLink: "http://knky.co/",
        popupImg: popupImg2,
    ...
    },
    {
        ...
        popupDescription: "Share content in up to 4K with flexible pricing. Unlock clips, stories, and drops with instant pay-per-view access.",
        popupButtonTitle: "Join KNKY →",
        popupButtonLink: "http://knky.co/",
        popupImg: popupImg3,
    ...
    },
    {
        ...
        popupDescription: "Host ticketed lives, streams, and private sessions. Sell digital or physical items while connecting in real time.",
        popupButtonTitle: "Join KNKY →",
        popupButtonLink: "http://knky.co/",
        popupImg: popupImg4,
    ...
    },
    {
        ...
        popupTitle: "Services",
        popupDescription: "Offer custom services, ratings, and one-to-one calls or requests. Create experiences fans can’t get anywhere else.",
        popupButtonTitle: "Join KNKY →",
        popupButtonLink: "http://knky.co/",
        popupImg: popupImg5,
    ...
    },
    {
        ...
        popupTitle: "Shopping",
        popupDescription: "Sell new and used products in one place. From merch to custom goods, everything you need to earn more.",
        popupButtonTitle: "Join KNKY →",
        popupButtonLink: "http://knky.co/",
        popupImg: popupImg6,
    ...
    },
    {
        ...
        popupTitle: "Play",
        popupDescription: "Engage fans with interactive games, roulettes, and fantasy. Turn fun into revenue with unique ways to play.",
        popupButtonTitle: "Join KNKY →",
        popupButtonLink: "http://knky.co/",
        popupImg: popupImg7,
    ...
    },
    {
        ...
        popupDescription: "Track sales, fans, and performance with ease. Insights that help you grow faster, optimise, and scale smarter.",
        popupButtonTitle: "Join KNKY →",
        popupButtonLink: "http://knky.co/",
        popupImg: popupImg8,
    ...
    },
    {
        ...
        popupDescription: "A discovery tool that connects fans with the right creators and like minded people. Matches services and content with what they want.",
    ...
    },
    {
        ...
        popupTitle: "Prime",
        popupDescription: "Helps fans discover creators, explore new trends, and enjoy content in stunning 4K without time wasted.",
    ...
    },
    {
        ...
        popupDescription: "Tools designed for serious creators ready to scale. Everything you need to grow, manage, and increase earnings.",
    ...
    },
    {
        ...
        popupTitle: "Business",
        popupDescription: "Dedicated accounts for stores, producers, and brands. Manage sales, services, and campaigns in one platform.",
    ...
    },
    {
        ...
        popupTitle: "Cash",
        popupDescription: "Revolutionizing the economy with WEB3 & AI-powered features focused on user rewards, setting the stage for a bold new era today!",
    ...
    },
    {
        ...
        popupTitle: "AI",
        popupDescription: "Smarter feeds, discovery, and engagement powered by AI. Personalised experiences that grow fans and revenue.",
        popupButtonTitle: "Join KNKY →",
        popupButtonLink: "http://knky.co/",
        popupImg: popupImg14,
...
export function Unlimited() {
    ...
    const [unlimited, setUnlimited] = useState<Unlimited>();
    ...
    useGSAP(
        () => {
            ...
            const grouped = Object.values(groupBy(list, 'priority'));
    ...
    const onOpenPopup = useCallback((unlimited: Unlimited) => {
        open();
    ...
    const onPrev = useCallback((id: number) => {
        if (id == 1) {
            setUnlimited(list[list.length - 2]);
            return;
        }
        return setUnlimited(list[id - 2]);
    }, []);
    ...
    const onNext = useCallback((id: number) => {
        ...
        return setUnlimited(list[id]);
    }, []);

    return (
        <Box h={1852} bg={"#F0F0FC"}>
