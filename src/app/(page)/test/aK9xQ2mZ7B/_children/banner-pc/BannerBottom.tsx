...
import text1 from "@public/version-3/banner/phase2/1.webp";
import text2 from "@public/version-3/banner/phase2/2.webp";
    ...
    useGSAP(
        () => {
            ...
            texts.forEach((el: any, index) => {
                tl.fromTo(
                    el,
                    { x: "100%", y: "80%", rotate: 100, autoAlpha: 0 },
                ...
                stars.forEach((o: any) => {
                    ...
                    // tl.fromTo(
                    //     o,
                    //     { x: (i, target) => gsap.getProperty(target, "x"),
                    //          y: index * 15 },
                    //     {
                    //         x: `+=-${x}`,
                    //         y: `+=${y}`,
                ...
                if (index < texts.length - 1) {
                    tl.fromTo(el, { x: 0, y: 0, autoAlpha: 1, rotate: 0 }, { x: "-100%", y: "80%", rotate: -90, autoAlpha: 0, duration: 1 });
                }
            });
        },
        {
    ...
    return (
        ...
        >
            {stars.map((o, i) => {
                ...
                // const left = getRandomInt(20 * i, 20 * (i + 1));
                // const width = getRandomInt(18, 40);
