...
export function AreaField(props: Props) {
  const {
    field,
    form,
    label,
  ...
  return (
    <div className="w-full flex flex-col h-fit relative gap-1">
      ...
      <Textarea
        ...
        classNames={{
          input: twMerge(
            "px-3 bg-white placeholder:text-[#4D5053] placeholder:font-normal text-black text-sm rounded-lg font-medium border border-solid border-[#E7E7F8]",
            className
          ),
          wrapper: "",
        }}
