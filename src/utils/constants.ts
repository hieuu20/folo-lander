...
export const fanConnections: Connection[] = [
  {
...
export const creatorConnections: Connection[] = [
    {
      img: "/connection/1.png",
      title: "Video Call",
      description:
        "Host face-to-face calls with fans for a personalised and engaging experience. Share unforgettable moments in real time!",
      bg: "#EEFAED",
    },
    {
      img: "/connection/2.png",
      title: "Ratings",
      description:
        "Receive ratings requests from fans, honest, complimentary, or cheeky, helping you showcase your appeal and grow your audience.",
      bg: "#E9F7FF",
    },
    {
      img: "/connection/3.png",
      title: "Call",
      description:
        "Offer one-on-one conversations for private chats, consultations, or deeper connections with your fans.",
      bg: "#F9F4F8",
    },
    {
      img: "/connection/4.png",
      title: "Roulette",
      description:
        "Engage with new fans in a fun, and spontaneous way - Think Omegle for adults. Roll the dice and start earning!",
      bg: "#F5F5F6",
    },
    {
      img: "/connection/5.png",
      title: "Spin the Wheel",
      description:
        "Set the stakes and let your fans spin for rewards, exclusive content, or unique experiences you design.",
      bg: "#FFF9E8",
    },
    {
      img: "/connection/6.png",
      title: "Make a Request",
      description:
        "Accept custom requests from fans and turn their ideas into reality. Create bespoke experiences and stand out!",
      bg: "#EEFAED",
    },
    {
      img: "/connection/7.png",
      title: "Fantasy",
      description:
        "Bring your fans’ fantasies to life by bidding on their unique requests - like freelancing, but for adults.",
      bg: "#F9EDFF",
    },
    {
      img: "/connection/8.png",
      title: "Match",
      description:
        "Tinder-style matching helps fans and collaborators discover you to align with their interests, kinks, and preferences.",
      bg: "#F9EDFF",
    },
    {
      img: "/connection/9.png",
      title: "And +1,000 Custom Services",
      description:
        "Offer an endless array of personalised services to engage fans and grow your income - there’s something for everyone!",
      bg: "#FFF9E8",
    },
  ];
